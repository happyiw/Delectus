...
//World
global.startRoom = rNeedle;         //Sets which room to begin with
global.roomCaptionDef = "I wanna Delectus";  //Sets default window caption (only works with the Professional version of Studio)
...
global.difficultyNames[2] = "Impossible";
